...
- Comandos personalizados (parâmetros, flags e permissões)
- Respostas automáticas configuráveis
- Menus interativos
- Comandos utilitários (texto, conversão, consultas, etc.)
- Envio e gerenciamento de mídias
- Sistema de vendas automáticas (quando configurado)
- Integração com APIs externas
- Sistema de permissões (owner, admin, grupo, privado)
- Suporte a WhatsApp multi-dispositivo
- Armazenamento em JSON / database local
...
# 🧠 Comandos Avançados
# ===============================
- Criação e edição de comandos em tempo real
...
- Placeholders dinâmicos:
  ...
  - {grupo}
  - {speed}
- Restrições por contexto (grupo / privado)
- Restrições por permissão (owner / admin)
